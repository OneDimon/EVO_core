...
# латиницу (Tc, Mt...) — это разошлось с LOCAL_MODEL_INSTRUCTIONS.md, SCL_FRACTAL_PROTOCOL.md
# и tests/test_notation.py, которые все написаны в терминах греческого алфавита.
# 24 строчных + 8 заглавных греческих букв = 32 уникальных однозначных символа,
# заглавные выбраны из тех, что уже фигурируют в спецификации (Φ, Ω, Σ, Δ, Ψ, Ξ, Θ, Λ).
ROOT_CODES: dict[str, str] = {
    ...
    "Электроника": "ε",   "Робототехника": "Ρ",  "Автоматизация": "Α",
    # ИИ и данные
    "ИИ": "Φ",            "МашОбучение": "θ",   "Данные": "δ",
    "Алгоритмы": "α",     "БазыДанных": "Δ",    "Сети": "ν",
    # Философия и гуманитарные
    "Философия": "φ",     "Лингвистика": "λ",   "Психология": "η",
    "Социология": "σ",    "Экономика": "ε".upper() if False else "Ε",  "Право": "π",
    # Практика
    "Медицина": "ι",      "Педагогика": "χ",    "Менеджмент": "Ψ",
    "Маркетинг": "ψ",     "Дизайн": "Ω",        "Искусство": "ω",
    # Системные
    "Безопасность": "ξ",  "Инфраструктура": "Σ",
}
...
def _get_root_code(science: str) -> str:
    ...
    # но не роняет запись: используем 'ω' (последняя буква) как маркер "неизвестно".
